...
var _isEmptyObject = __webpack_require__(11);
...
var prioritize = function () {
    function prioritize() {
        _classCallCheck(this, prioritize);
    ...
    */
    ...
    _createClass(prioritize, [{
        key: 'pajax',
        value: function pajax() {
            var _this = this;

            var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;

            // Return if no options are given
            if (options == null || (0, _isEmptyObject2.default)(options)) {
                return false;
            }
            ...
            console.log(options.data, _qs2.default.stringify(options.data));
            //Make the actual request
            return (0, _axios2.default)({
                method: options.type,
                url: options.url,
                data: _qs2.default.stringify(options.data),
                cancelToken: options.cancelToken
            }).then(function (response) {
                options.priority == 'high' ? _this.highPCleanUp(options.cancelToken) : _this.lowPCleanUp(options.cancelToken);
                if (options.success) {
        ...
        key: 'highPCleanUp',
        value: function highPCleanUp(cancelToken) {
        ...
        key: 'lowPCleanUp',
        value: function lowPCleanUp(cancelToken) {
            // Remove entry from N-Stack
        ...
        key: 'restartWaitingRequests',
        value: function restartWaitingRequests() {
        ...
        key: 'cancelGlobal',
        value: function cancelGlobal(g_cancel) {
